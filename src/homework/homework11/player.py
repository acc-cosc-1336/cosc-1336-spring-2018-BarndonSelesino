...
class Player:
    ...
    def __init__(self, game_log):
        self.die1 = Die() #ASSIGNMENT12: update the statement to use the die1 parameter argument
        self.die2 = Die() #ASSIGNMENT12: update the statement to use the die2 parameter argument
