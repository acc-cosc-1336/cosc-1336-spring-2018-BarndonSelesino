...
1In the constructor, call the Die class constructor(__init__ method) and pass it parameter arguments self and 6.
2Define a class method named roll.
In the method:
...
#2
    def roll(self):
        print('Rolled 6 sided die', self.sides)
